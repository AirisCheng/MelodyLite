...
public class ConsumerServiceImpl implements ConsumerService {
    ...
    @Override
    public Consumer verifySecurityAnswer(Consumer consumer) {
        Consumer result = consumerMapper.getByUsername(consumer.getUsername());
        if(result != null && result.getSecurityAnswer().equals(consumer.getSecurityAnswer())){
            return result;
        }
        return null;
    }
