...
public class SongController {
     ...
     * 根据歌词模糊查询歌曲
     */
    @RequestMapping(value = "/likeSongOfLyric", method = RequestMethod.GET)
    public Object likeSongOfLyric(HttpServletRequest request) {
        String lyric = request.getParameter("lyric").trim();
        return songService.likeSongOfLyric(lyric);
    }
}